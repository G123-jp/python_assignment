...
def make_response(data_type: str, id_key: str, data: Union[Dict, List[Dict]], pagination_data: Dict = None) -> str:
    """
    ...
    Args:
        ...
        pagination_data: pagination data dictionary (optional)
    Returns:
    ...
    if pagination_data:
        page_data = dict(page=pagination_data)
        result['meta'] = page_data
    return json.dumps(result, ensure_ascii=False)


def _make_response_item(data_type: str, id_key: str, data: Dict) -> dict:
    return dict(type=data_type, id=data[id_key], attributes=data)
